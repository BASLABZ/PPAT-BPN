            ...
            <div class="box box-danger">
              ...
              <br>
                ...
                <tbody>
                 <?php 
                      $no = 1;
                      $query = mysql_query("SELECT * FROM ppat p JOIN pengguna pe ON p.idpengguna = pe.idpengguna where p.verifikasi='BELUM DIVERIFIKASI' AND pe.idpengguna = '".$idpengguna."' order by p.idppat DESC");
